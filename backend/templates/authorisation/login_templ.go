...
func Login() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<main class=\"d-flex flex-column justify-content-center p-2\"><div class=\"container rounded d-flex justify-content-center card card-green w-100\" style=\"max-width: 40rem\"><div class=\"card-header text-center\"><h1 id=\"stockmarket-header\">")
